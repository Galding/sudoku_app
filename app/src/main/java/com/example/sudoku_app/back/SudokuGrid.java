...
public class SudokuGrid {
    ...
    public void setElementToGrid(int element, int colIndex, int rowIndex) {
        grid.get(colIndex).set(rowIndex, element);
    }
    ...
    public List<Integer> get_square(int rowIndex, int colIndex) {
        List<Integer> result = new ArrayList<>();

        Map<Integer, Integer> firstSquareCase = get_first_case_of_a_square(rowIndex, colIndex);
